...
[^4]:A Brief Overview of the Federal Trade Commission’s Investigative, Law Enforcement, and Rulemaking Authority, Federal Trade Commission (Jun. 7, 2013), https://www.ftc.gov/about-ftc/mission/enforcement-authority.
[^5]:Data Breach Notification Laws by State | IT Governance USA, https://itgovernanceusa.com/data-breach-notification-laws (last visited May 29, 2025).
[^6]:Milad Nasr et al., Scalable Extraction of Training Data from (Production) Language Models (Nov. 28, 2023), http://arxiv.org/abs/2311.17035; 
...
[^7]: NATIONAL INSTITUTES OF HEALTH (NIH), NOT-OD-25-081: Protecting Human Genomic Data When Developing Generative Artificial Intelligence Tools and Applications, https://grants.nih.gov/grants/guide/notice-files/NOT-OD-25-081.html (last visited May 4, 2025); 
